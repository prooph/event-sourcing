...
namespace Prooph\EventSourcingTest\Mapping;
 ...
 *
 * @package Prooph\EventSourcingTest\Mapping
...
class AggregateRootDecoratorTest extends TestCase
{
    ...
    public function it_extracts_the_pending_events_from_given_aggregate_root()
    {
        ...
        $this->assertInstanceOf('Prooph\EventSourcingTest\Mock\UserCreated', $userCreatedEvent);
    }
